...
public final class ItemBuilder {
     ...
     * @deprecated paper use component to set the display name
     */
    @Deprecated
     ...
     * @param lore the Lore
     * @return the ItemBuilder
     * @deprecated paper use component to set the lore
     */
    @Deprecated
     ...
     * Add many Safe Enchantments
     *
     * @param enchantments a map which include an Enchantment and the level
     * @return the ItemBuilder
     */
